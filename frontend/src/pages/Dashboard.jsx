            ...
            <div className="px-6 py-6">
                ...
                <div className="w-full space-y-6">
                    <div className="flex flex-col lg:flex-row gap-6">
                        ...
                        <div className="flex-1 bg-white p-4 rounded-xl shadow flex flex-col gap-2">
                            <div className="flex items-center gap-2">
                                <i className="fas fa-money-bill fa-xl" style={{ color: "#f79494ff" }} />
                        ...
                        <div className="flex-1 bg-white p-4 rounded-xl shadow flex flex-col gap-2">            
                            <div className="flex items-center gap-2">
                                <i className="fas fa-wallet fa-xl" style={{ color: "#7CD6F2" }} />
                    ...
                    {budget ? (<div>
                        ...
                        <div className="bg-white p-4 rounded-xl shadow flex items-center gap-4">
                            <i className="fas fa-trophy fa-xl" style={{ color: "orange" }} />
